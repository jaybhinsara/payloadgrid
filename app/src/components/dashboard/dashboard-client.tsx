...
const nav: Array<{ id: View; label: string; icon: typeof Gauge; group: string }> = [
  ...
  { id: "api-keys", label: "API keys", icon: KeyRound, group: "Manage" }, { id: "team", label: "Team", icon: Users, group: "Manage" }, { id: "usage", label: "Usage", icon: BarChart3, group: "Manage" }, { id: "settings", label: "Automations", icon: Settings2, group: "Manage" }
];
