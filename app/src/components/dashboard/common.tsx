...
export function StatusIcon({ status }: { status: string }) { return status === "delivered" ? <CircleCheck size={15} /> : ["failed", "dead_letter", "cancelled"].includes(status) ? <CircleX size={15} /> : <RefreshCw size={14} />; }
