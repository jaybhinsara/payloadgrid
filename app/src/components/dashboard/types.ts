...
export type Endpoint = { id: string; application_id: string | null; name: string; provider: string; destination_url: string; signing_secret: string | null; provider_verification_required: boolean; provider_secret_hint: string | null; is_active: boolean; circuit_breaker_enabled: boolean; circuit_breaker_threshold: number; circuit_state: "closed" | "open"; circuit_opened_at: string | null; event_types: string[]; created_at: string };
