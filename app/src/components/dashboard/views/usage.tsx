...
export function UsageView({ data }: { data: DashboardData }) {
  ...
  return <>
    ...
    {data.usage.plan.id === "free" ? <section className="content-card billing-callout"><div><span className="section-label">Paid capacity</span><h3>Need more events or retention?</h3><p>Starter includes 100,000 accepted events, 30 endpoints, 10 members, and 14-day payload retention for $29 USD per workspace each month.</p></div><Link className="button primary" href="/pricing">View Starter</Link></section> : null}
  </>;
}
