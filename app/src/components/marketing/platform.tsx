...
export function PlatformSection() {
  return <section className="unified-platform" id="platform">
    ...
    <div className="platform-mode inbound-mode" data-reveal>
      ...
      <div className="mode-copy"><span className="mode-index">02 / INBOUND</span><i><ArrowDownToLine size={21} /></i><h3>Put a reliable gateway in front of every provider callback.</h3><p>Give payment, commerce, and custom providers a stable PayloadGrid URL. Every callback is stored, forwarded, measured, and recoverable from the same console.</p><ul><li><Check size={15} /> Provider-specific source routes</li><li><Check size={15} /> Original headers and payload capture</li><li><Check size={15} /> Revenue-at-risk visibility</li></ul></div>
    </div>
