  ...
  return <section className="production-section" id="reliability">
    <div className="production-copy" data-reveal>
      ...
      <div className="production-metrics">
        <div><strong>Transactional</strong><span>message, fan-out, and dispatch intent</span></div>
        <div><strong>Asynchronous</strong><span>delivery outside the acceptance request</span></div>
        <div><strong>100 events</strong><span>maximum bounded batch</span></div>
        <div><strong>4 MB</strong><span>maximum batch body</span></div>
        <div><strong>256 KB</strong><span>maximum event payload</span></div>
        <div><strong>24 hours</strong><span>dual-signature rotation window</span></div>
      </div>
    </div>
