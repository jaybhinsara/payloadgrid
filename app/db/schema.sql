...
-- Exact accepted-event usage without scanning event tables on every request.
-- Usage is append-only for the billing month, even when retained payload records are deleted.
begin;
